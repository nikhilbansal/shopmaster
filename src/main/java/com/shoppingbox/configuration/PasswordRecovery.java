package com.shoppingbox.configuration;

import com.shoppingbox.configuration.index.IndexPasswordRecoveryConfiguration;
...
public enum PasswordRecovery implements IProperties{
    ...
    final static Logger logger = LoggerFactory.getLogger(PasswordRecovery.class);
